...
Para la elaboración del informe correspondiente al Trabajo Final (TF), se realizó una nueva división del trabajo centrada en la consolidación del Capítulo VIII (Experiment-Driven Development), el cierre analítico del experimento y la preparación de los entregables finales (Conclusiones, Bibliografía, Anexos y material audiovisual). Cada integrante asumió secciones específicas del índice, incorporando los avances previos del TB2 y alineando el documento final con los objetivos experimentales de FrostLink.

| Integrantes                             | Tareas Asignadas                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| --------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **León Vivas, Fabrizio Amir**           | Responsable de la columna vertebral del Capítulo VIII y de los entregables globales. Desarrolla **8.3.3 Pipeline-supported, Experiment-Driven To-Be Software Platform Lifecycle**, articulando la relación entre backlog, experimentos y plataforma. Elabora **8.3.3.2 Implemented To-Be Landing Page Evidence**, **8.3.3.3 Implemented To-Be Frontend-Web Application Evidence** y **8.3.3.6 Team Collaboration Insights**, documentando la implementación, el rol del equipo y la integración con el ciclo de experimentación. Completa **8.3.4.1 Diseño de Entrevistas** y **8.3.4.2 Registro de Entrevistas** en su versión final. Además, lidera **8.4 Experiment Aftermath & Analysis** y **8.4.1 Analysis and Interpretation of Results**, redactando el análisis posterior al experimento. Finalmente, asume la redacción y consolidación de los entregables globales: **Conclusiones**, **Conclusiones y recomendaciones**, **Video App Validation**, **Video About-The-Team**, **Bibliografía** y **Anexos**. |
| **Medina Cruzado, Raúl Adrian**         | Focalizado en la capa técnica de la plataforma. Desarrolla **8.3.3.4 Implemented To-Be Native-Mobile Application Evidence**, documentando la evidencia de la aplicación móvil nativa (arquitectura, vistas clave, flujos críticos). Completa **8.3.3.5 Implemented To-Be RESTful API and/or Serverless Backend Evidence**, describiendo los servicios expuestos, endpoints relevantes y su rol en el soporte al experimento. Además, es responsable de **8.6.1 About-the-Product Intro Video**, definiendo el guion técnico-funcional y los aspectos principales del video de introducción al producto FrostLink.                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Tello Murga, Javier Oswaldo**         | Responsable de la dimensión de validación y aprendizaje continuo. Elabora **8.3.4 To-Be Validation Interviews**, integrando los hallazgos de las entrevistas To-Be, su interpretación y conexión con las hipótesis del experimento. Desarrolla **8.5 Continuous Learning**, donde sintetiza las lecciones aprendidas, mecanismos de retroalimentación y cómo estas alimentan iteraciones futuras. Comparte responsabilidad sobre **8.6 To-Be Software Platform Pre-launch**, describiendo las actividades y consideraciones para la etapa de pre-lanzamiento de la plataforma, en coordinación con Sebastián.                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Pereira Vasquez, Fabrizzio**          | Apoya de forma transversal en la **revisión, coherencia narrativa y refinamiento visual** del Capítulo VIII y de los entregables finales. Verifica que las descripciones de evidencia implementada (frontend, backend, mobile y landing) sean consistentes con las experiencias de usuario documentadas en etapas previas (TB2) y coopera en la preparación de anexos gráficos (capturas, recorridos, diagramas) que se referencian en las secciones **8.3.3.x** y **8.3.4.x**. Además, participa en la revisión final de **Conclusiones, Bibliografía y Anexos**, asegurando homogeneidad de formato y estilo en todo el TF.                                                                                                                                                                                                                                                                                                                                                                                           |
| **Varela Bustinza, Marcelo Alessandro** | Encargado de consolidar la visión To-Be a nivel de definición funcional. Desarrolla **8.3.1 To-Be User Stories**, refinando y alineando las historias de usuario con las hipótesis experimentales. Completa **8.3.2 To-Be Product Backlog**, priorizando ítems en función del aprendizaje esperado y las métricas de negocio. Redacta **8.3.3.1 To-Be Sprint Backlogs**, detallando la planificación de sprints, objetivos, tareas y cómo cada iteración contribuye a la validación de FrostLink. Su trabajo sirve como base para la correcta interpretación de los resultados en 8.4 y para la coherencia entre diseño, implementación y experimento.                                                                                                                                                                                                                                                                                                                                                                  |
| **Ramos Calagua, Sebastian Alexander**  | Responsable del cierre analítico de las preguntas de experimento y del flujo de aprendizaje compartido. Desarrolla **8.4.2 Re-scored and Re-prioritized Question Backlog**, revaluando las preguntas del experimento a la luz de la evidencia obtenida y ajustando la priorización futura. Completa **8.5.1 Shareback Session Artifacts: Learning Workflow**, documentando cómo se socializan los aprendizajes dentro del equipo y qué artefactos se generan. Comparte responsabilidad en **8.6 To-Be Software Platform Pre-launch**, complementando la visión de pre-lanzamiento con los ajustes derivados del backlog de preguntas, y colabora en la definición de próximos pasos hacia una versión lista para producción.                                                                                                                                                                                                                                                                                            |
